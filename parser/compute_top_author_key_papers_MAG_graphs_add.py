...
selectTopfieldAuthors = "select authorID, name, authorRank, PaperCount_field from scigene_$$fieldNAME$$_field.authors_field where authorRank <= $$NUMTOPAUTHORS$$ and authorRank > 200;"
