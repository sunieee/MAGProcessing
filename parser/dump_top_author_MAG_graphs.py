...
dumpTopfieldAuthors = """select * from scigene_$$fieldNAME$$_field.authors_field where authorRank <= $$NUMTOPAUTHORS$$ INTO OUTFILE '/home/leishi/scigene/dataset/MAG/parser/data/csv/$$fieldNAME$$/top_field_authors.csv' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\\n'"""
