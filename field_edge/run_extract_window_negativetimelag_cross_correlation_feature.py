...
maxTimeLag = 5
window_size = 5
feature_name = "window_negativetimelagged_cross_correlation_feature"
...
df_feature = pd.DataFrame({"window_negativetimelagged_cross_correlation_feature": feature_name_list})
...
# for row in rows:
#     features_group_one.append(float(str(row[0]).strip().split(":")[2]))
#     window_offset_one.append(int(str(row[0]).strip().split(":")[1]))
#     time_lag_one.append(int(str(row[0]).strip().split(":")[0]))
...
# for row in rows:
#     features_group_two.append(float(str(row[0]).strip().split(":")[2]))
#     window_offset_two.append(int(str(row[0]).strip().split(":")[1]))
#     time_lag_two.append(int(str(row[0]).strip().split(":")[0]))
...
# print(
#     "time lag average:",
#     str(average(time_lag_one)),
#     ",",
#     str(average(time_lag_two)),
# )
